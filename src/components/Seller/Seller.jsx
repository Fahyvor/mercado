    ...
    return (
        <div className='w-full flex gap-3'>
            <div className="w-[5%] md:w-[20%] lg:w-[20%] ">
                ...
                <div className={`dashboard_nav bg-gray-200 flex flex-col gap-4 w-full h-full py-3
                ${isMenuOpen ? 'absolute top-40' : 'hidden'}
                lg:block`}>
                    <p className="bg-green-500 p-2 text-white cursor-pointer" onClick={() => {
                        setShowActiveNav('product');
                        setIsMenuOpen(false);
                    }}>Products</p>
                    <div className="add_products flex gap-3 items-center p-3 bg-gray-100 cursor-pointer" onClick={() => {
